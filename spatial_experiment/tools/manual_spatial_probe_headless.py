...
Usage
-----
python spatial_experiment/tools/manual_spatial_probe_headless.py \
  --scene-dir 00149-UuwwmrTsfBN --scene-id UuwwmrTsfBN \
  --ref-filter toilet --tgt-filter tray \
  --out spatial_experiment/outputs_v2/manual_probe
...
def main():
    ...
    ap.add_argument("--out", default="spatial_experiment/outputs_v2/manual_probe")
