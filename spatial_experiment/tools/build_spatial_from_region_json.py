...
Example:
  ...
  python spatial_experiment/tools/list_region_objects.py \
    --scene-dir 00006-HkseAnWCgqk --scene-id HkseAnWCgqk \
    --regions-with couch \
    --out-json spatial_experiment/outputs_v2/couch_regions.json

  # 2) Build 10 questions for region _8 using the 'couch' as reference,
  #    and also compute distances wrt 'dining table'
  python spatial_experiment/tools/build_spatial_from_region_json.py \
    --scene-dir 00006-HkseAnWCgqk --scene-id HkseAnWCgqk \
    --region-json spatial_experiment/outputs_v2/couch_regions.json \
    --region-id _8 \
    --ref-substr "couch" \
    --also-ref2-substr "dining table" \
    --num-questions 10 \
    --min-dist 0.2 --max-dist 2.0 \
    --dataset-out spatial_experiment/outputs_v2/spatial_dataset_v2_single.json \
    --table-out   spatial_experiment/outputs_v2/rel_table_00006.csv
"""
