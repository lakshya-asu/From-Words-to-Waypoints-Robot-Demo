#!/usr/bin/env python3
# /home/artemis/project/graph_eqa_swagat/spatial_experiment/scripts/run_spatial_experiment_v4.py
"""
v4 runner:
- Same as v3 runner, but imports the v4 planner (PoE-capable).
- You can keep using your spatial_vqa_v3.yaml (set vlm.msp.mode: "poe" to activate PoE).
"""
...
from spatial_experiment.planners.vlm_planner_gemini_spatial_v4_poe import (
    VLMPlannerEQAGeminiSpatialV4,
)
...
def main(cfg):
    ...
    for task_index, task_data in enumerate(tqdm(tasks_data, desc="Running Tasks (v4)")):
        ...
        pipeline = None
        try:
            click.secho(f"[v4] Executing task: {experiment_id}", fg="green")
            ...
            # Planner V4 (MSP + PoE-capable)
            vlm_planner = VLMPlannerEQAGeminiSpatialV4(
