...
Example:
  python spatial_experiment/tools/region_dump_from_spawn.py \
    --scene-dir 00006-HkseAnWCgqk --scene-id HkseAnWCgqk \
    --spawn-x 1.1563 --spawn-y 2.2306 --spawn-z -0.5356 --spawn-yaw 5.3783249199074 \
    --out-json spatial_experiment/outputs_v2/region_dump_00006.json \
    --save-360-dir spatial_experiment/outputs_v2/region_dump_00006_360 --views 8 \
    --neighbors-k 6 --neighbor-dist 5.0 --door-region-dist 3.0 \
    --save-neighbor-dir spatial_experiment/outputs_v2/region_dump_00006_neighbors \
    --name-precision 4
"""
