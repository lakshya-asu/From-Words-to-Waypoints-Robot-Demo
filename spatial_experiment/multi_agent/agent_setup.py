    ...
    def create_agent(role: str, provider: str = "gemini", **kwargs):
        ...
        if role == "orchestrator":
            if provider == "openai":
                ...
                from spatial_experiment.multi_agent.agents.alibaba_orchestrator_agent import AlibabaOrchestratorAgent
            ...
            if provider == "openai":
                ...
                from spatial_experiment.multi_agent.agents.alibaba_logical_agent import AlibabaLogicalAgent
            ...
            if provider == "openai":
                ...
                from spatial_experiment.multi_agent.agents.alibaba_grounding_agent import AlibabaGroundingAgent
            ...
            if provider == "openai":
                ...
                from spatial_experiment.multi_agent.agents.alibaba_spatial_agent import AlibabaSpatialAgent
            ...
            if provider == "openai":
                ...
                from spatial_experiment.multi_agent.agents.alibaba_verifier_agent import AlibabaVerifierAgent
            ...
            if provider == "openai":
                ...
                from spatial_experiment.multi_agent.agents.alibaba_qa_agent import AlibabaQaAgent
